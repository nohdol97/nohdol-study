<!-- 생성된 요약 뷰입니다. AGENTS.md를 직접 편집하고 이 파일을 다시 생성하세요. source-sha256: ac83e5bc98c7c127290ae8055fc587297ad4c8060697a7d75a275bb5c32edcc9 -->
...
- Phase 2b는 project-local Understand Anything·Obsidian 스킬과 보안 게이트가 있는 NotebookLM CLI bridge를 추가한다. 검증 pin 설치기·`understand-*` adapter 9종·typed 지식 그래프는 구현됐고, Obsidian 형식 스킬·NotebookLM bridge는 아직이다.
