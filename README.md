...
- **Korean, English, and paired reading**: All 94 articles include reviewed Korean text beside the English original. Collapse explanations to practice comprehension, search either language, and open terminology definitions in context. CDC, dbt, and other core technologies include examples and role comparisons. Code, output fixtures, and diagrams appear once. Interface language is a separate saved preference. See the [bilingual reading specification](docs/specs/2026-09-11-bilingual-reading.md).
