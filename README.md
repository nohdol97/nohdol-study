...
- **Korean explanation review**: All 20 Data and Observability/SRE translations explain mechanisms through concrete actions and failure sequences. The [readability review](docs/reviews/2026-09-12-data-observability-korean-readability.md) records chapter coverage and verification limits.
...
- **Korean, English, and paired reading**: All 94 articles put Korean first in paired mode, with English passages that can be collapsed individually or together. Glossary entries show their meaning first; expand an entry for its purpose and a situation, application, and check. The Data course uses short, concrete introductions and plain-language definitions. Search supports both languages; code, output fixtures, and diagrams appear once. Interface language remains a separate saved preference. See the [bilingual reading specification](docs/specs/2026-09-11-bilingual-reading.md).
