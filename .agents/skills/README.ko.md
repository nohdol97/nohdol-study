...
The public [Data & Observability course](../../docs/guides/data-observability/00-roadmap.md) is a learning resource, not a new skill. Use existing study routing for guided learning and source verification. The public gateway offers a Korean/English interface and reviewed Korean translations for all 94 articles, with separate Korean, English, and paired reading modes. Every glossary definition includes its purpose and an illustrative situation, application, and verification step in both languages; core technology entries also compare adjacent roles. See the [bilingual reading specification](../../docs/specs/2026-09-11-bilingual-reading.md).
