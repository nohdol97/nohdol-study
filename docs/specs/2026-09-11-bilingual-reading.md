...
The scenario extension opens all 1,160 term dialogs offered across the 94 article routes and checks bilingual purpose paragraphs plus three scenario steps, each with English and Korean text. The count includes definitions reused in related chapters. A source comparison confirms that the 132 edited English/Korean Markdown files retain their original definitions, purposes, executable examples, source records, and structure while appending illustrative scenarios.
