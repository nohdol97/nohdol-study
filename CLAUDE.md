...
- `understand-*` graphs are navigation. Confirm any factual answer in the source file before finishing, and keep the dashboard and Figma paths explicit-use only.
